    ...
    <div className="glass-card p-4 space-y-4">
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full rounded-md border-purple-500/30 bg-white/10 text-gray-100 shadow-sm focus:border-purple-500 focus:ring-purple-500 text-sm backdrop-blur-md"
        >
